...
public class TodoFragment extends ButterKnifeFragment {
                ...
                new JsonObjectRequest(
                        ...
                        new Response.Listener<JSONObject>() {
                            ...
                            public void onResponse(JSONObject response) {
                                ...
                                todoAdapter.setWorkOrderProcessInfoList(workOrderProcessInfoList);
        ...
        SimpleVolley.addRequest(new JsonObjectRequest(getUrl(pageNo + 1),
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        todoAdapter.getWorkOrderProcessInfoList().addAll(workOrderProcessInfoList);
                        todoAdapter.notifyDataSetChanged();
                        checkLastPage(response);
                    }
                },
    ...
    private String getUrl(Integer pageNo) {
        Uri.Builder builder = Uri.parse(ConfigUtils.getBaseUrl() + "/api/v1/hems/workOrder/issue/timeout?").buildUpon();
