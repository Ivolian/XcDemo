package com.unicorn.csp.xcdemo.fragment.supervisor;

import android.os.Bundle;

import com.unicorn.csp.xcdemo.adaper.recycleview.supervisor.WorkOrderSuspendedAdapter;
...
public class WorkOrderSuspendedFragment extends RefreshFragment {
    ...
    @Subscriber(tag = "supervisor_workOrderSuspendedFragment_refresh")
