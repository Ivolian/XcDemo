...
public class RedForewarningAdapter extends RecyclerView.Adapter<RedForewarningAdapter.ViewHolder> implements RefreshAdapter {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int position) {
        ...
        viewHolder.tvMessage.setTextColor(ContextCompat.getColor(viewHolder.tvMessage.getContext(), R.color.md_red_400));
