package com.unicorn.csp.xcdemo.fragment.supervisorManager;

import android.os.Bundle;

import com.unicorn.csp.xcdemo.adaper.recycleview.shared.RefreshAdapter;
import com.unicorn.csp.xcdemo.adaper.recycleview.supervisorManager.WorkOrderSuspendedAdapter;
...
public class WorkOrderSuspendedFragment extends RefreshFragment {
    ...
    @Subscriber(tag = "supervisorManager_workOrderSuspendedFragment_refresh")
