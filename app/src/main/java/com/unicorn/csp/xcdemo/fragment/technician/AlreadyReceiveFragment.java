...
public class AlreadyReceiveFragment extends ButterKnifeFragment {
    ...
    AlreadyReceiveAdapter alreadyReceiveAdapter;
    ...
    public void initRecyclerView() {
        ...
        recyclerView.setAdapter(alreadyReceiveAdapter = new AlreadyReceiveAdapter());
