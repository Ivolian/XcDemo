...
public class WorkOrderTodoFragment extends ButterKnifeFragment {
    ...
    public int getLayoutResId() {
        return R.layout.fragment_work_order_todo;
    }
    ...
    public void onCreateOptionsMenu(android.view.Menu menu, MenuInflater inflater) {
        inflater.inflate(R.menu.menu_work_order_todo, menu);
    ...
    private void initSearchView(MenuItem menuItem) {
        ChiefMainActivity chiefMainActivity = (ChiefMainActivity) getActivity();
        MaterialSearchView searchView = chiefMainActivity.searchView;
