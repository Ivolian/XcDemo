...
import com.unicorn.csp.xcdemo.adaper.recycleview.technician.AlreadySuspendAdapter;
...
public class AlreadySuspendFragment extends ButterKnifeFragment {
    ...
    AlreadySuspendAdapter alreadyReceiveAdapter;
    ...
    public void initRecyclerView() {
        ...
        recyclerView.setAdapter(alreadyReceiveAdapter = new AlreadySuspendAdapter());
                ...
                new JsonObjectRequest(
                        ...
                        new Response.Listener<JSONObject>() {
                            ...
                            public void onResponse(JSONObject response) {
                                ...
                                alreadyReceiveAdapter.setWorkOrderProcessInfoList(workOrderProcessInfoList);
                                alreadyReceiveAdapter.notifyDataSetChanged();
        ...
        SimpleVolley.addRequest(new JsonObjectRequest(getUrl(pageNo + 1),
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        alreadyReceiveAdapter.getWorkOrderProcessInfoList().addAll(workOrderProcessInfoList);
                        alreadyReceiveAdapter.notifyDataSetChanged();
                        checkLastPage(response);
                    }
                },
    ...
    private String getUrl(Integer pageNo) {
        Uri.Builder builder = Uri.parse(ConfigUtils.getBaseUrl() + "/api/v1/hems/workOrder/hangUp?").buildUpon();
