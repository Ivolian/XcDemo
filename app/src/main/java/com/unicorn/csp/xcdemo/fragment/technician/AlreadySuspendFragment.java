...
public class AlreadySuspendFragment extends BasicRefreshRecycleFragment {

    AlreadySuspendAdapter adapter;

    public void initRecyclerView() {
        recyclerView.setLayoutManager(RecycleViewUtils.getLinearLayoutManager(getActivity()));
        recyclerView.setAdapter(adapter = new AlreadySuspendAdapter());
