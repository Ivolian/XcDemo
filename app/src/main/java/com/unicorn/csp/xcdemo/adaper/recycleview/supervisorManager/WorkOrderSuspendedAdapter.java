package com.unicorn.csp.xcdemo.adaper.recycleview.supervisorManager;
...
public class WorkOrderSuspendedAdapter extends RecyclerView.Adapter<WorkOrderSuspendedAdapter.ViewHolder> implements RefreshAdapter {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        String refreshEventTag = "supervisorManager_workOrderSuspendedFragment_refresh";
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        return new ViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_work_order_suspended_supervisor_manager, viewGroup, false));
    }
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int position) {
        ...
        viewHolder.btnAgree.setVisibility(workOrderInfo.getHangUpStatus() == 3 ? View.VISIBLE : View.GONE);
        viewHolder.btnDisagree.setVisibility(workOrderInfo.getHangUpStatus() == 3 ? View.VISIBLE : View.GONE);
